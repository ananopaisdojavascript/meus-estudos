...
const someString = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua';
// console.log(stringLength(someString))
...
const lowerCaseLetters = string => string.toLowerCase()
const sentence = "CHOCOTONE E OVO DE PÁSCOA JUNTOS NO MERCADO EM PLENO FEVEREIRO"
// console.log(lowerCaseLetters(sentence))
...
const findCharacterIndex = (string, char) => string.indexOf(char)
// console.log(findCharacterIndex(sentence, 'C'))
...
const doesTheArrayInclueThisValue = (array, number) => array.includes(number)
// console.log(doesTheArrayInclueThisValue(someNumbers, 3))
...
const concatNumberArrays = (arr1, arr2) => arr1.concat(arr2)
// console.log(concatNumberArrays(num1, num2))
...
const frutas = ['banana', 'pera', 'laranja', 'uva']
const removeLastArrayItem = (array) => {
    array.pop()
    return array
}
// console.log(removeLastArrayItem(frutas))
...
const isThisValueNull = (value) => value === null
// console.log(isThisValueNull(5))
...
// const numbers = [1, 2, 3]
// const showNumbersInfo = (number, index, array) => console.log(`O ${index+1}º item do array [${array.join(', ')}] é ${number}.`) 
...
const names = ['Ana', 'Jennie', 'Lisa', 'Irene', 'SoYeon']
const likes = (array) => {
    ...
    switch (arrayLength) {
        ...
        default:
            return console.log(`${array[0]}, ${array[1]} e mais ${arrayLength - 2} pessoas curtiram isso`)
    }
    return array
}
