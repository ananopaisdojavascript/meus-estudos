...
const oddNumbers = randomNumbers.filter(isThisNumberOdd)
...
const countNumbersLowerThan501 = (accumulator, item) => {
    return item < 501 ? accumulator + 1 : accumulator
}
...
const gameList = cart.reduce((accumulator, { name }) => `${accumulator}- ${name}\n`, '')
