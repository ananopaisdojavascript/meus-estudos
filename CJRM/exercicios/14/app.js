...
li.forEach(item => {
  const isThisListItemEven = Number(item.innerText) % 2 === 0
  if (isThisListItemEven) {
...
const includeLink = link.setAttribute('href', 'https://github.com/roger-melo-treinamentos/curso-de-js-roger-melo')
