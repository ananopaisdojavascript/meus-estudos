...
//     const lowerTagName = event.target.tagName.toLowerCase()
//     event.stopPropagation()
//     h2.textContent = `Clicou no ${lowerTagName}, filho da div.`
//   })
// })

const showClickedMessage = ({target}) => {
...
div.addEventListener('click',showClickedMessage)
...
*/
const copyText = event =>  console.log("Texto copiado!")
...
const axis = ({ offsetX, offsetY }) => egg.textContent = `Eixo X: ${offsetX} | Eixo Y: ${offsetY}`
egg.addEventListener('mousemove', axis)
...
const findFrontend = people.some(({profession}) => profession === 'Front-end developer')
if(findFrontend) {
