...
// console.log(pushToBrazilianFoods);
...
const pushToDogNames = dogNames.push('Nina')
// console.log(dogNames)
...
const replaceDessert = dessert.replace(dessert[4], 'd')
// console.log(replaceDessert)

// console.log('A ' + replaceDessert + ' um doce à base de coco, tradicional na América Latina e em Angola.');
